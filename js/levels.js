...
let levels = [
  {
    ...
    reference:
      '<ul><li><a href="https://github.com/mrdoob/three.js/" target="_blank">Three.js GitHub repo</a></li><li><a href="https://threejs.org/docs/index.html#manual/en/introduction/Installation" target="_blank">Installation - three.js docs</a></li><li><a href="https://threejs.org" target="_blank">Three.js docs</a></li></ul>',
    skeleton: '',
    language: 'html',
    tag: 'html',
    startPosition: [0, 0],
  ...
  },
  {
    ...
    reference:
      '<ul><li><a href="https://threejsfundamentals.org/" target="_blank">Three.js Fundamentals</a></li></ul>',
    skeleton: '',
    language: 'javascript',
    tag: 'js',
    startPosition: [0, 0],
